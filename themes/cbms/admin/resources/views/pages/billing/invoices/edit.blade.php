                                                ...
                                                <div class="col-lg-6 p-2">
                                                   ...
                                                   <div class="row justify-content-center">
                                                      ...
                                                      <div class="mt-3">
                                                       ...
                                                       {{--  <button type="button" class="btn btn-success m-1 px-3" data-toggle="modal" data-target="#sendCustomWAModal" onclick="setGroupName({{ $client->groupid }})">
                                                           Resend WA By GroupClients
                                                       </button> --}}

                                                       <button type="button" class="btn btn-success m-1 px-3" data-toggle="modal" data-target="#sendCustomWAModal" data-groupid="{{ $client->groupid }}">
                                                        ...
                                                        <div class="mt-3">
                                                           <button onclick="resendInvoiceWAAllClients()" class="btn btn-primary">Resend WA to All Clients</button>
                                                      </div>
                                                   </div>
                                          ...
                                          <form action="" method="POST">
                                             <div class="row py-3">
                                                ...
                                                <div class="col-lg-6">
                                                   ...
                                                   <div class="form-group row">
                                                      <label for="dueDateOption" class="col-sm-2 col-form-label">Due Date
                                                         </label>
                                                      <div class="col-sm-10">
                                                         <div class="input-daterange input-group inputdate">
                                                    ...
                                                    {{--@if(in_array($invoice->status, ['Paid', 'Collection']))
                                                   <div class="form-group row">
                                                      <label for="datePaidOption" class="col-sm-2 col-form-label">Date Paid</label>
                                                      <div class="col-sm-10">
                                                      ...
                                                      <div class="col-sm-10">
                                                         <div class="input-group">
                                                               <input type="text" name="datepaid"
                                                                  value="{{ $invoice->datepaid ? Carbon::parse($invoice->datepaid)->format('d/m/Y') : '' }}"
                                                                  class="form-control inputdate"
                                                                  id="datePaidOption" 
                                                                  placeholder="DD/MM/YYYY"
                                                                  autocomplete="off">
                                                               <input type="time" name="datepaid_time" 
                                                                  value="{{ $invoice->datepaid ? Carbon::parse($invoice->datepaid)->format('H:i') : '00:00' }}"
                                                                  class="form-control"
                                                                  style="width: 120px; cursor: pointer;"
                                                                  onclick="this.showPicker()"
                                                                  onkeydown="return false">
                                                         </div>
                                                         <small class="text-muted">Current: {{ $invoice->datepaid ? Carbon::parse($invoice->datepaid)->format('d/m/Y H:i:s') : 'Not set' }}</small>
                                                      </div>
                                                   </div>
                                                   @endif
                                                   ...
                                                   <div class="form-group row">
                                                      <label for="statusInvoiceOptions" class="col-sm-2 col-form-label">Status</label>
                                                      <div class="col-sm-10">
                                                         <select class="form-control" name="status" id="statusInvoiceOptions">
                                                               <option value="Draft" class="text-secondary" {{ $invoice->status == 'Draft' ? 'selected' : '' }}>
                                                                  Draft
                                                               </option>
                                                               <option value="Unpaid" class="text-danger" {{ $invoice->status == 'Unpaid' ? 'selected' : '' }}>
                                                                  Unpaid
                                                               </option>
                                                               <option value="Paid" class="text-success" {{ $invoice->status == 'Paid' ? 'selected' : '' }}>
                                                                  Paid
                                                               </option>
                                                               <option value="Cancelled" {{ $invoice->status == 'Cancelled' ? 'selected' : '' }}>
                                                                  Cancelled
                                                               </option>
                                                               <option value="Refunded" {{ $invoice->status == 'Refunded' ? 'selected' : '' }}>
                                                                  Refunded
                                                               </option>
                                                               <option value="Collections" {{ $invoice->status == 'Collections' ? 'selected' : '' }}>
                                                                  Collections
                                                               </option>
                                                               <option value="Payment Pending" {{ $invoice->status == 'Payment Pending' ? 'selected' : '' }}>
                                                                  Payment Pending
                                                               </option>
                                                         </select>
                                                      </div>
                                                   ...
                                                   <tbody>
                                                      @foreach ($invoiceitems as $r)
                                                         <tr>
                                                               ...
                                                               <td>
    <select class="form-control lineitem" name="item[{{ $r->id }}][type]">
        <option value="">Select Type</option>
        <option value="none" {{ $r->type == 'none' ? 'selected' : '' }}>None</option>
        @foreach($types as $type)
            <option value="{{ $type }}" {{ $r->type == $type ? 'selected' : '' }}>
                {{ $type }}
            </option>
        @endforeach
    </select>
                                                               ...
                                                               <td>
    <select class="form-control lineitem" name="item[{{ $r->id }}][relid]">
        <option value="">Select Related Item</option>
        <option value="none" {{ $r->relid == 'none' ? 'selected' : '' }}>None</option>
        @foreach($relidOptions as $option)
            <option value="{{ $option['id'] }}" {{ $r->relid == $option['id'] ? 'selected' : '' }}>
                {{ $option['detail'] }}
            </option>
        @endforeach
    </select>
                                                               ...
                                                               <td>
                                                                  <div class="form-check text-center align-middle mt-2">
                                                                     <input class="form-check-input text-center align-middle"
        ...
        <select class="form-control" name="addtype">
            ...
            @endforeach
                                                         ...
                                                         <td>
                                                            <select class="form-control" name="addrelid">
                                                               <option value="">Select Related Item</option>
                                                               <option value="none">None</option>
                                                               @foreach($relidOptions as $option)
                                                                     <option value="{{ $option['id'] }}">{{ $option['detail'] }}</option>
                                                               @endforeach
                                                            </select>
                                                         </td>
                                                         <td>
...
<tfoot>
    ...
    @if ($data['taxname'])
        <tr class="bg-light">
            <td colspan="4" class="text-right">{{ $data['taxrate'] }}% {{ $data['taxname'] }}</td>
    ...
    @if ($data['taxname2'])
        <tr class="bg-light">
            <td colspan="4" class="text-right">{{ $data['taxrate2'] }}% {{ $data['taxname2'] }}</td>
    ...
    @endif
    <tr class="bg-light">
        <td colspan="4" class="text-right">Credit</td>
                                    ...
                                    <div class="modal fade" id="sendCustomWAModal" tabindex="-1" role="dialog" aria-labelledby="sendCustomWAModalLabel" aria-hidden="true">
                                        {{-- <div class="modal-dialog" role="document"> --}}
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <div class="modal-footer">
                                              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                              <button type="button" class="btn btn-primary" onclick="resendWAByGroup(this.form)">Send Message</button>
                                          </div>
                                    </form>
                                            </div>
                                        </div>
...
@section('scripts')
   ...
   <script>
   document.getElementById('statusInvoice').addEventListener('change', function() {
    if (this.value === 'Paid') {
        // Set hidden input datepaid dengan waktu sekarang
        document.getElementById('datepaid').value = new Date().toISOString().slice(0, 19).replace('T', ' ');
    }
});

   $('#sendCustomWAModal').on('show.bs.modal', function (event) {
       var button = $(event.relatedTarget); 
       var groupId = button.data('groupid'); 
       var modal = $(this);
       modal.find('#customWAForm').data('groupid', groupId); 
   });

   function resendWAByGroup(form) {
       const groupId = $(form).data('groupid') || 1; 
       const customMessage = form.message.value.replace(/\n/g, '%0A'); 
       const delay = form.delay.value;

       $.get(`/admin/clients/viewclients/getGroupName/${groupId}`, function(groupName) {
           Swal.fire({
               title: `Kirim WA ke Group "<strong>${groupName || 'Bandung'}</strong>"?`,
               ...
               if (result.isConfirmed) {
                   window.open(`/admin/clients/viewclients/resendWABulk?show_loading=1&groupid=${groupId}&message=${encodeURIComponent(customMessage)}&delay=${delay}`, '_blank');
               }
           });
       });
   }

      function resendInvoiceWAAllClients() {
       Swal.fire({
           title: 'Kirim WA ke Semua Klien?',
           text: "Pesan WA akan dikirim ke semua klien yang aktif",
           icon: 'question',
           showCancelButton: true,
           confirmButtonColor: '#3085d6',
           cancelButtonColor: '#d33',
           ...
           if (result.isConfirmed) {
               window.open(`/admin/clients/viewclients/resendWAAllClients?show_loading=1`, '_blank');
           }
       });
   }
...
function sendWAMessage() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.open(`/admin/clients/viewclients/sendCustomWA?show_loading=1`, '_blank');
        }
    });
}
   </script>
   <script type="text/javascript">
    ...
    // Optional: Tambahkan validasi waktu
    $('#timePaidOption').on('change', function() {
        if (!this.value) {
            this.value = '00:00';
        }
    });
