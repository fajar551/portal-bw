...
<body>
   <div class="container" style="position:relative;">
      ...
      <table border="0" width="100%" class="invoiceaddres table">
         <tr>
            ...
            <td width="50%" style="border-top:0; text-align:right;">
               ...
               <h5>Due Date:</h5>
               <p class="date"> {{ $invoice['duedate'] }}</p>
            </td>
      ...
      <table width="100%" class="table table-condensed table-striped table-bordered" style="margin-bottom: 100px;">
         <thead>
            <tr>
         ...
         <tbody>
            ...
            @endforeach
            <tr>
               <td align="right" class="total-row text-right"><b>Tax {{$invoice['taxrate']}} %</b></td>
      ...
      <div class="diskripsi" style="font-size: 18px; margin-bottom:40px;">
         ...
         <p>
            Faktur pajak hanya dapat diminta melalui layanan support tiket dengan melampirkan NPWP dan SPPKP perusahaan
            anda.</p>
